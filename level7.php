...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .house.found .house-family { opacity: 1; }
...
<script>
    $(document).ready(function() {
        ...
        function getRandomHouseAsset() {
            return houseAssets[Math.floor(Math.random() * houseAssets.length)];
        }
        ...
        function placeFamily(idx) {
            ...
            let newAsset = getRandomHouseAsset();
            let $house = $(`#house-${idx}`);
            $house.find('.house-icon').attr('src', newAsset);
