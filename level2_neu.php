...
<script>
    $(document).ready(function() {
        ...
        // --- Level 2 Spielmechanik (OHNE TEXTFELD) ---
        ...
        $('.house').click(function() {
            ...
            if (currentOccupant !== null) {
                ...
                $('#dialogueText').html(
                    "Sehr gut! Dies ist das richtige Haus. Wie du siehst, ist es aber schon belegt. So kann Dieter also nicht einziehen. Da muss ich mir erstmal was ausdenken, wie wir dieses Problem lösen. Bis später!"
                );
