                ...
                <div class="houses-row">
                    <?php for ($i = 0; $i < 5; $i++): ?>
                        <div class="house-container" id="house-<?php echo $i; ?>" data-house="<?php echo $i; ?>">
                            <img src="assets/Wohnhaus2BlauRot.svg" class="img-house-base" alt="Haus Basis">
        ...
        $('.house-container').click(function(e) {
            ...
            if (gamePhase === "placement_click") {
                ...
                if (clickedHouse === currentHash) {
                    ...
                    if (bewohnerAnzahl > 1) {
                        var extensionImg = $('<img src="assets/WohnhausBlauRotErweiterung.svg" class="img-house-extension" alt="Erweiterung">');
                        $houseElement.append(extensionImg);
                    }
